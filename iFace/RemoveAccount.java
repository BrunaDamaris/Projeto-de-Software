...
public class RemoveAccount {
	public static void toRemoveTheUser(ArrayList<Users> user,ArrayList<Community> communities,String username,int userid) {
		...
		RemoveAccount.RemoveFromFriendsList(user,user.get(userid).getFriends(),username);
	...
	public static void RemoveFromFriendsList(ArrayList<Users> user,ArrayList<String> Friends,String username) {
		String friend;
		int friendsid = -1;
